...
<div class="patients margin--top">
  <div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <a href="/management/patients/create.php" class="btn btn-primary">
      ...
      <form method="GET" class="row g-3">
        <div class="col-12 col-md-4">
          <div class="input-group">
            ...
            <?php if (!empty($search)): ?>
              <a href="/management/patients/index.php" class="btn btn-outline-secondary">Xóa</a>
            <?php endif; ?>
          </div>
        </div>
      </form>
              ...
              <?php while ($row = mysqli_fetch_assoc($result)): ?>
                <tr>
                  ...
                  <td class="text-end px-4">
                    <a href="/management/patients/edit.php?id=<?php echo $row['id']; ?>" class="btn btn-sm btn-outline-primary me-2">
                      <i class="fas fa-edit"></i>
                    </a>
                    <a href="/management/patients/delete.php?id=<?php echo $row['id']; ?>"
