...
<div class="departments margin--top">
  <div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <a href="/management/departments/create.php" class="btn btn-primary">
              ...
              <?php while ($row = mysqli_fetch_assoc($result)): ?>
                <tr>
                  ...
                  <td class="text-end px-4">
                    <a href="/management/departments/edit.php?id=<?php echo $row['id']; ?>" class="btn btn-sm btn-outline-primary me-2">
                      <i class="fas fa-edit"></i>
                    </a>
                    <a href="/management/departments/delete.php?id=<?php echo $row['id']; ?>"
